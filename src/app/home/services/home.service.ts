...
import { SetNowPlayingMovies, SetUpcomingMovies, SetCastAndCrew, SetTheaters, SetGenre } from '../store/actions/home.action';
...
export class HomeService {
  ...
  fetchGenres() {
    this.http.get(this.genresUrl).subscribe(res => {
      this.store.dispatch(new SetGenre(res['genres']));
